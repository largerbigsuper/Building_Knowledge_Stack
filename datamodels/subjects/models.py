...
class SubjectConfig(models.Model):
    ...
    danxuan_score = models.PositiveSmallIntegerField(default=0, verbose_name='试卷单选题分数')
    duoxuan_count = models.PositiveSmallIntegerField(default=0, verbose_name='试卷多选选题个数')
    duoxuan_score = models.PositiveSmallIntegerField(default=0, verbose_name='试卷多选选题分数')
    panduan_count = models.PositiveSmallIntegerField(default=0, verbose_name='试卷判断题个数')
    panduan_score = models.PositiveSmallIntegerField(default=0, verbose_name='试卷判断题分数')
